...
URL="https://github.phxc8.com/ent/kangle-ent-$VERSION$ARCH.tar.gz"
...
sleep 3
mkdir -p $PREFIX
wget https://github.phxc8.com/ent/license/Ultimate/license.txt -O $PREFIX/license.txt
./install.sh $PREFIX
$PREFIX/bin/kangle
...
wget https://github.phxc8.com/easypanel/index.html -O $PREFIX/www/index.html
$PREFIX/bin/kangle -q
