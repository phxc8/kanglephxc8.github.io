...
PREFIX="/vhs/kangle/ext/tpl_php72"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c https://github.phxc8.com/php/source/7.2/php-7.2.25.tar.bz2 -O php-7.2.25.tar.bz2
tar xjf php-7.2.25.tar.bz2
cd php-7.2.25
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.phxc8.com/php/source/7.2/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.phxc8.com/php/source/7.2/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c https://github.phxc8.com/php/source/7.2/ioncube-$ZEND_ARCH-7.2.zip
...
#install sg11
wget https://github.phxc8.com/php/sg11-$ZEND_ARCH/ixed.7.2.lin -O $PREFIX/ixed.7.2.lin
#install apcu
wget -c https://github.phxc8.com/php/source/7.2/apcu-5.1.17.tgz
tar zxf apcu-5.1.17.tgz
cd apcu-5.1.17
/vhs/kangle/ext/tpl_php72/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php72/bin/php-config
make -j `grep processor /proc/cpuinfo | wc -l`
make install
cd ..
#install libmemcached
wget -c https://github.phxc8.com/php/source/7.2/libmemcached-1.0.18.tar.gz
...
cd ..
#install memcached
wget -c https://github.phxc8.com/php/source/7.2/php-memcached-3.1.3-dev.zip
unzip -o php-memcached-3.1.3-dev.zip
cd php-memcached-3.1.3-dev
/vhs/kangle/ext/tpl_php72/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php72/bin/php-config --disable-memcached-sasl
make -j `grep processor /proc/cpuinfo | wc -l`
make install
cd ..
#install memcache
wget -c https://github.phxc8.com/php/source/7.2/php-memcache-4.0.4-dev.zip
