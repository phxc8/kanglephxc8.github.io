...
PREFIX="/vhs/kangle/ext/tpl_php70"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c https://github.phxc8.com/php/source/7.0/php-7.0.33.tar.bz2 -O php-7.0.33.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.phxc8.com/php/source/7.0/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.phxc8.com/php/source/7.0/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c https://github.phxc8.com/php/source/7.0/ioncube-$ZEND_ARCH-7.0.zip
...
#install sg11
wget https://github.phxc8.com/php/sg11-$ZEND_ARCH/ixed.7.0.lin -O $PREFIX/ixed.7.0.lin
#install apcu
wget -c https://github.phxc8.com/php/source/7.0/apcu-5.1.15.tgz
tar zxf apcu-5.1.15.tgz
cd apcu-5.1.15
/vhs/kangle/ext/tpl_php70/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php70/bin/php-config
make -j `grep processor /proc/cpuinfo | wc -l`
make install
cd ..
#install libmemcached
wget -c https://github.phxc8.com/php/source/7.0/libmemcached-1.0.18.tar.gz
...
cd ..
#install memcached
wget -c https://github.phxc8.com/php/source/7.0/php-memcached-3.1.0-dev.zip
unzip -o php-memcached-3.1.0-dev.zip
cd php-memcached-3.1.0-dev
/vhs/kangle/ext/tpl_php70/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php70/bin/php-config --disable-memcached-sasl
make -j `grep processor /proc/cpuinfo | wc -l`
make install
cd ..
#install memcache
wget -c https://github.phxc8.com/php/source/7.0/php-memcache-3.0.9-dev.zip
