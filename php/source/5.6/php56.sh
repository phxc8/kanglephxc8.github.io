...
PREFIX="/vhs/kangle/ext/tpl_php56"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c https://github.phxc8.com/php/source/5.6/php-5.6.40.tar.bz2 -O php-5.6.40.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://github.phxc8.com/php/source/5.6/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://github.phxc8.com/php/source/5.6/php-templete.ini -O $PREFIX/php-templete.ini
#install zend
wget -c https://github.phxc8.com/php/source/5.6/zend-loader-php5.6-linux-$ZEND_ARCH.tar.gz
...
cd ..
#install ioncube
wget -c https://github.phxc8.com/php/source/5.6/ioncube-$ZEND_ARCH-5.6.zip
...
#install sg11
wget https://github.phxc8.com/php/sg11-$ZEND_ARCH/ixed.5.5.lin -O $PREFIX/ixed.5.6.lin
#install apcu
wget -c https://github.phxc8.com/php/source/5.6/apcu-4.0.10.tgz
tar zxf apcu-4.0.10.tgz
cd apcu-4.0.10
/vhs/kangle/ext/tpl_php56/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php56/bin/php-config
make -j `grep processor /proc/cpuinfo | wc -l`
make install
cd ..
#install memcache
wget -c https://github.phxc8.com/php/source/5.6/memcache-3.0.8.tgz
