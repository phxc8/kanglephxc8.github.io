...
mkdir -p $PHP_TMP
wget -c https://github.phxc8.com/php/completed/5.4/tpl_php53.tar.bz2 -O $PHP_TMP/tpl_php54.tar.bz2
tar -jxvf $PHP_TMP/tpl_php54.tar.bz2
mv $PHP_TMP/tpl_php54 $PREFIX
rm -rf $PHP_TMP
