...
PHP_TMP="/root/php/"
mkdir -p $PHP_TMP
wget -c https://github.phxc8.com/php/completed/7.1/tpl_php71.tar.bz2 -O $PHP_TMP/tpl_php71.tar.bz2
tar -jxvf $PHP_TMP/tpl_php71.tar.bz2
mv $PHP_TMP/tpl_php71 $PREFIX
rm -rf $PHP_TMP
