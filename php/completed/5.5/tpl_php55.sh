...
PHP_TMP="/root/php/"
mkdir -p $PHP_TMP
wget -c https://github.phxc8.com/php/completed/5.5/tpl_php55.tar.bz2 -O $PHP_TMP/tpl_php55.tar.bz2
tar -jxvf $PHP_TMP/tpl_php55.tar.bz2
mv $PHP_TMP/tpl_php55 $PREFIX
rm -rf $PHP_TMP
